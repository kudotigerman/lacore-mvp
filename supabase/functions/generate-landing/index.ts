...
const systemPrompt = `You are a senior conversion copywriter and front-end designer. Output ONE complete landing page HTML document. No markdown, no explanations, no code fences — raw HTML only, starting with <!DOCTYPE html>.
